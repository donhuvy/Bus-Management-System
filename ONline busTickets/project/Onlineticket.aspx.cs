...
namespace project
{
    public partial class Onlineticket : System.Web.UI.Page
    {
        static int[] bookedseat=new int[16];
        static int[] tempbookseat=new int[16];
        ...
        {
            //string str1 = ("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog='J:\\WEB PROJECT\\ONLINE BUSTICKETS\\PROJECT\\APP_DATA\\TICKINFO.MDF';Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            ...
            String myquery = "Select * from Tabley";
            ...
            da.Fill(ds);
            int dsx = ds.Tables.Count;
            int rowx = ds.Tables[0].Rows.Count;
            int i = 0;
            while (i < rowx)
            {
                String status;
        ...
        protected void Button17_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < 16; i++)
            {
                ...
                {
                    String mycon = ("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename='J:\\web project\\ONline busTickets\\project\\App_Data\\tickinfo.mdf';Integrated Security=True");
                    String updatedata = "Update Tabley set status='B' where seatno=" + (i + 1);
                    SqlConnection con = new SqlConnection(mycon);
                    con.Open();
                    SqlCommand cmd = new SqlCommand();
